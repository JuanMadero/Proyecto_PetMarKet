              ...
              <form action="usuario" method="post">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="Nombre" aria-label="First name"
                          name="usuario" value="${usuarioL.getUsuario()}">
                        <input hidden name="idUsuario" type="text" value="${usuarioL.getIdUsuario()}">
                      </div>
                      <div class="col-sm-6">
                        <label for="">Contraseña Usuario</label>
                        <input type="password" class="form-control" placeholder="Nombre" aria-label="First name"
                          name="password" value="${usuarioL.getPass()}">
                        <input hidden name="idUsuario" type="text" value="${usuarioL.getIdUsuario()}">
                      </div>
                      <div class="col-sm-6">
                        <label for="">vuelve a ingresar Contraseña </label>
                        <input type="password" class="form-control" placeholder="Nombre" aria-label="First name" value="${usuarioL.getPass()}">
                        <input hidden name="idUsuario" type="text" value="${usuarioL.getIdUsuario()}">
                      </div>
                      <div class="col-sm-6">
                        <label for="">Nombre Usuario</label>
                        <input type="text" class="form-control" placeholder="Nombre" aria-label="First name"
                          name="nombre" value="${usuarioL.getNombre()}">
                        <input hidden name="idUsuario" type="text" value="${usuarioL.getIdUsuario()}">
                      </div>
                      <div class="col-sm-6">
                        <label for="">Correo Usuario</label>
                        <input type="email" class="form-control" placeholder="Apellido" aria-label="First name"
                          name="correo" value="${usuarioL.getCorreo()}">
                        <input hidden name="idUsuario" type="text" value="${usuarioL.getIdUsuario()}">
                      </div>
                      <div class="col-sm-6">
                        <label class="label">Rol<span class="text-danger"></span></label>
                        <select name="rol" id="tipoDoc" class="form-control" value="${usuarioL.getRol()}">
                  ...
                  <div style="text-align: center;">
                    <button type="submit" name="atcion" value="edit" class="btn btn-info">Editar Usuario</button>
                  </div>
                </div>
              </div>
              </form>
